        ...
        function atualizarTabelaDetalhes() {
            if (detalhesTable) {
                ...
                detalhes.forEach(function(detalhe, index) {
                    ...
                    if (tempoCell) {
                        // **Adição da Funcionalidade de Hover para Exibir HH:MM:SS**
                        
                        // Adiciona o atributo data-hovered
                        tempoCell.setAttribute("data-hovered", "false");

                        // Função para atualizar o tempo na célula considerando o estado de hover
                            ...
                            if (detalhe.isFuture) {
                                ...
                                if (remaining <= 0) {
                                    ...
                                    var elapsedInterval = setInterval(function() {
                                        ...
                                        if (tempoCell.getAttribute("data-hovered") === "true") {
                        ...
                        tempoCell.addEventListener("mouseover", function() {
                            tempoCell.setAttribute("data-hovered", "true");
                            var now = Date.now();
                            if (detalhe.isFuture) {
                                var remaining = detalhe.timestamp - now;
                                tempoCell.textContent = formatTime(remaining, true);
